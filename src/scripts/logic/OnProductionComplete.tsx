...
export function onProductionComplete({ xy, offline }: { xy: Tile; offline: boolean }): void {
   ...
   switch (building.type) {
      ...
      case "Colosseum": {
         ...
         if (!Tick.current.notProducingReasons.has(xy) && Config.Building.Colosseum.input.Chariot !== null && Config.Building.Colosseum.input.Chariot !== undefined) {
      ...
      case "ContainerPortShanghai":
      case "ContainerPortSingapore":
      case "ContainerPortNingboZhoushan":
      case "ContainerPortLosAngeles":
      case "ContainerPortMundra":
      case "ContainerPortPiraeus":
      case "ContainerPortSantos":
      case "ContainerPortTokyo":
      case "ContainerPortGioiaTauro":
      case "ContainerPortPortSaid":
      case "ContainerPortFelixstowe":
