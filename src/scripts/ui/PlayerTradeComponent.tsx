         ...
         <div className="window-body">
            <div className="row g10" style={{ alignItems: "stretch", height: 300 }}>
               <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                  ...
                  <div className="row">
                     <div className="f1">
                        <button className="f1" onClick={(e) => { savedMaxTradeAmountFilter = 1e6; forceUpdate(); applyFilters(); }}>
                           1M
                        </button>
                        <button className="f1" onClick={(e) => { savedMaxTradeAmountFilter = 1e7; forceUpdate(); applyFilters(); }}>
                           10M
                        </button>
                        <button className="f1" onClick={(e) => { savedMaxTradeAmountFilter = 1e8; forceUpdate(); applyFilters(); }}>
                           100M
                        </button>
                        <button className="f1" onClick={(e) => { savedMaxTradeAmountFilter = 1e9; forceUpdate(); applyFilters(); }}>
                           1B
                        </button>
                     </div>
                  </div>
