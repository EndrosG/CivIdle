...
const BuildingBodyOverride: Partial<Record<Building, FunctionComponent<IBuildingComponentProps>>> = {
   ...
   Caravansary2: PlayerTradeBuildingBody,
   Caravansary3: PlayerTradeBuildingBody,
   Caravansary4: PlayerTradeBuildingBody,
   ...
   ContainerPortShanghai: GrandBazaarBuildingBody,
   ContainerPortSingapore: GrandBazaarBuildingBody,
   ContainerPortNingboZhoushan: GrandBazaarBuildingBody,
   ContainerPortLosAngeles: GrandBazaarBuildingBody,
   ContainerPortMundra: GrandBazaarBuildingBody,
   ContainerPortPiraeus: GrandBazaarBuildingBody,
   ContainerPortSantos: GrandBazaarBuildingBody,
   ContainerPortTokyo: GrandBazaarBuildingBody,
   ContainerPortGioiaTauro: GrandBazaarBuildingBody,
   ContainerPortPortSaid: GrandBazaarBuildingBody,
   ContainerPortFelixstowe: GrandBazaarBuildingBody,
