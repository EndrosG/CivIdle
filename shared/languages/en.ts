export const EN = {
   // Lydias Mod
   BuildingStack: "Stack",
   ConstructionDeliveredTooltip: "First row: cost for next level (or stack). Second row: total cost",
   Downgrade: "Downgrade",
   DowngradeBuilding: "Downgrade",
   DowngradeBuildingNotProducingDescV2: "This building is being downgraded - <b>production will halt until upgrade is complete</b>",
   DowngradeTo: "Downgrade To Level %{level}",
   Stack: "Stack",
   StackBuilding: "Stack",
   ...
   Caravansary4: "Caravansary 4.0",
   Warehouse2: "Warehouse 2.0",
   Warehouse3: "Warehouse 3.0",
   Future2: "Future 2.0",
   Future3: "Future 3.0 Wisdom",
   Future4: "Future 4.0 ZPM",
   ...
   Retreat2: "The big retreat",
   Retreat2Desc: "The one place where you can finally find inner peace.",
   Wisdom: "Wisdom",
   ...
   VanGoghMuseumDesc: "Opened 1973 in Amsterdam.",
   InternationalCriminalCourt: "International Criminal Court",
