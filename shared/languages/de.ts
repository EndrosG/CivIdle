export const DE = {
   // Lydias Mod
   BuildingStack: "Anzahl",
   ConstructionDeliveredTooltip: "Obere Zeile: Kosten der nächsten Stufe. Untere Zeile: Gesamtkosten",
   Downgrade: "Rückbau",
   DowngradeBuilding: "Gebäude zurückbauen",
   DowngradeBuildingNotProducingDescV2: "Dieses Gebäude wird zurückgebaut - <b>Produktion ist angehalten bis zum Abschluss</b>",
   DowngradeTo: "Rückbau auf Stufe %{level}",
   Stack: "Erweiterung",
   ...
   WirecardAG: "Wirecard AG (insolvent)",
   EVDummy: "EV Mess-Dummy",
   ...
   Caravansary4: "Karawanserei 4.0",
   Warehouse2: "Lager 2.0",
   Warehouse3: "Lager 3.0",
   Future2: "Zukunft 2.0",
   Future3: "Zukunft 3.0 Weisheit",
   Future4: "Zukunft 4.0 ZPM",
   ...
   Retreat2: "Der große Rückzug",
   Retreat2Desc: "Ein Ort, an dem man endgültig innere Ruhe und Frieden finden kann.",
   Wisdom: "Weisheit",
   ...
   VanGoghMuseumDesc: "Das Kunstmuseum wurde 1973 in Amsterdam eröffnet.",
   InternationalCriminalCourt: "Internationaler Strafgerichtshof",
   InternationalCriminalCourtDesc: "Verbessert die Wirksamkeit von Gerichtsgebäuden. Kann ausgebaut werden.",
   DeltaWorks: "Deltawerke",
   DeltaWorksDesc: "Verbessert die Wasser- und Strom-Versorgung.",

   // Lydia: waste disposal sites
   KotiRepository: "Koti-Endlager",
   KotiRepositoryDesc: "Ein dauerhaftes Endlager für Koti (auch aus Handelsgeschäften). Das Endlager kann ausgebaut werden und erzeugt -3 Zufriedenheit pro Stufe.",
   NuclearWaste: "Atommüll",
   NuclearWasteRepository: "Atommüll-Endlager",
   ...
   FriedrichMagirius: "Friedrich Magirius",
   ...
   PlayerTradePlayerBanNameFilter: "auszuschließende Spieler",
   PlayerTradePercentageFilter: "Prozent-Filter (Profit)",
